...
const AccountPage = () => {
  return (
    ...
    <div className='absolute top-0 left-0 w-[372px] h-[68px] bg-white box-shadow opacity-100'>
      ...
      <div className='bg-gray-600 w-[76px] h-[76px] rounded-full absolute top-[98px] left-[20px]  '>
        ...
        <img src="/public/camera.png" alt="camera" className='absolute left-[79px] top-[147px] w-[21px] h-[23px] ' />

      <h1 className='absolute top-[98px] left-[116px] text-[#1D2226] text-[15px] leading-[19px] text-left font-medium font-rubik capitalize'>Marry Doe</h1>

      <h1 className='absolute top-[122px] left-[116px] text-[14px] leading-[19px] text-left text-[#1D2226] tracking-normal font-normal font-rubik'>marry@gmail.com</h1>
